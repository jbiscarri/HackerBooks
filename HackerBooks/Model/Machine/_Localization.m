...
// Make changes to Localization.m instead.

#import "_Localization.h"

const struct LocalizationAttributes LocalizationAttributes = {
	.address = @"address",
	.latitude = @"latitude",
	.longitude = @"longitude",
};

const struct LocalizationRelationships LocalizationRelationships = {
	.annotation = @"annotation",
};

@implementation LocalizationID
@end
...
- (LocalizationID*)objectID {
	return (LocalizationID*)[super objectID];
}
